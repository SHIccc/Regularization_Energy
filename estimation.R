...
save(fit1, file="lassolag1n.RData")
print("finished!")
...
fit1= SIS(kx1,cy1,family = "gaussian", penalty = "lasso", tune="bic")
save(fit1, file="lassolag2n.RData")
print("finished!")
...
fit1= SIS(kx1,cy1,family = "gaussian", penalty = "lasso", tune="bic")
save(fit1, file="lassolag3n.RData")
print("finished!")
...
fit1= SIS(kx1,cy1,family = "gaussian", penalty = "lasso", tune="bic")
save(fit1, file="lassolag4n.RData")
print("finished!")
...
fit1= SIS(kx1,cy1,family = "gaussian", penalty = "lasso", tune="bic")
save(fit1, file="lassolag5n.RData")
print("finished!")
...
fit1= SIS(kx1,cy1,family = "gaussian", penalty = "SCAD", tune="bic")
save(fit1, file="scadlag1n.RData")
print("finished!")
...
fit1= SIS(kx1,cy1,family = "gaussian", penalty = "SCAD", tune="bic")
save(fit1, file="scadlag2n.RData")
print("finished!")
...
fit1= SIS(kx1,cy1,family = "gaussian", penalty = "SCAD", tune="bic")
save(fit1, file="scadlag3n.RData")
print("finished!")
...
fit1= SIS(kx1,cy1,family = "gaussian", penalty = "SCAD", tune="bic")
save(fit1, file="scadlag4n.RData")
print("finished!")
...
fit1= SIS(kx1,cy1,family = "gaussian", penalty = "SCAD", tune="bic")
save(fit1, file="scadlag5n.RData")
print("finished!")